...
class __$$GetFavoritesListImplCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_$GetFavoritesListImpl(
      null == isRefresh
          ? _value.isRefresh
...
mixin _$FavoritesState {
  ...
  List<FavoritesDTO> get favouriteList => throw _privateConstructorUsedError;
...
abstract class $FavoritesStateCopyWith<$Res> {
  ...
  $Res call(
      ...
      List<FavoritesDTO> favouriteList});
}
...
class _$FavoritesStateImpl implements _FavoritesState {
  _$FavoritesStateImpl(
      ...
      required final List<FavoritesDTO> favouriteList})
  ...
  final List<FavoritesDTO> _favouriteList;
  @override
  List<FavoritesDTO> get favouriteList {
  ...
  @override
  String toString() {
    return 'FavoritesState(isSubmitting: $isSubmitting, isLoading: $isLoading, showError: $showError, isNoDataFound: $isNoDataFound, favouriteIds: $favouriteIds, favouriteList: $favouriteList)';
  }
...
abstract class _FavoritesState implements FavoritesState {
  factory _FavoritesState(
      ...
      required final List<int> favouriteIds,
      required final List<FavoritesDTO> favouriteList}) = _$FavoritesStateImpl;
